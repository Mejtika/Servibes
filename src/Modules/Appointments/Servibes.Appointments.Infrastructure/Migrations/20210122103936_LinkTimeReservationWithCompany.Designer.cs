...
namespace Servibes.Appointments.Infrastructure.Migrations
{
    ...
    [Migration("20210122103936_LinkTimeReservationWithCompany")]
    partial class LinkTimeReservationWithCompany
    {
            ...
            modelBuilder.Entity("Servibes.Appointments.Core.Appointments.Appointment", b =>
                {
                    ...
                    b.OwnsOne("Servibes.Appointments.Core.Appointments.Employee", "Employee", b1 =>
                        {
                    ...
                    b.OwnsOne("Servibes.Appointments.Core.Appointments.Service", "Service", b1 =>
                        {
                            b1.Property<Guid>("AppointmentId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Servibes.Appointments.Core.Shared.ReservationDate", "ReservedDate", b1 =>
                        {
                            b1.Property<Guid>("AppointmentId")
                                .HasColumnType("uniqueidentifier");
