...
namespace Servibes.BusinessProfile.Api.Events.External.ClientInformationUpdated
{
    public class ClientInformationUpdatedEventHandler : INotificationHandler<ClientInformationUpdatedEvent>
    {
        private readonly BusinessProfileContext _context;

        public ClientInformationUpdatedEventHandler(BusinessProfileContext context)
        {
            _context = context;
        }
